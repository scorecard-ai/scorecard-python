...
__all__ = ["TestcaseCreateResponse", "Item", "ItemValidationError"]
...
class Item(BaseModel):
    ...
    validation_errors: Optional[List[ItemValidationError]] = FieldInfo(alias="validationErrors", default=None)
