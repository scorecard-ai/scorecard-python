    ...
    def create(
        ...
        *,
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            method="POST",
            json={"metric_id": metric_id, "int_score": int_score, "binary_score": binary_score, "reasoning": reasoning},
    ...
    def update(
        ...
        *,
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            method="PATCH",
            json={"int_score": int_score, "binary_score": binary_score, "reasoning": reasoning},
            request_options=request_options,
            omit=OMIT,
        )
        if 200 <= _response.status_code < 300:
