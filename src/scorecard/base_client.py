...
from .testcase.client import TestcaseClient
from .testrecord.client import TestrecordClient
...
from .testrecord.client import AsyncTestrecordClient
...
class BaseScorecard:
    ...
    environment : ScorecardEnvironment
        The environment to use for requests from the client. from .environment import ScorecardEnvironment



        Defaults to ScorecardEnvironment.DEFAULT
    ...
    def __init__(
        ...
        *,
        ...
        if api_key is None:
            raise ApiError(
                body="The client must be instantiated be either passing in api_key or setting SCORECARD_API_KEY"
            )
