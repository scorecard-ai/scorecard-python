...
from scorecard_ai.types.records import AnnotationListResponse
...
class TestAnnotations:
    ...
    def test_method_list(self, client: Scorecard) -> None:
        annotation = client.records.annotations.list(
            "777",
        )
    ...
    def test_raw_response_list(self, client: Scorecard) -> None:
        response = client.records.annotations.with_raw_response.list(
            "777",
        )
    ...
    def test_streaming_response_list(self, client: Scorecard) -> None:
        with client.records.annotations.with_streaming_response.list(
            "777",
        ) as response:
    ...
    def test_path_params_list(self, client: Scorecard) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `record_id` but received ''"):
            client.records.annotations.with_raw_response.list(
                "",
            )
...
class TestAsyncAnnotations:
    ...
    async def test_method_list(self, async_client: AsyncScorecard) -> None:
        annotation = await async_client.records.annotations.list(
            "777",
        )
        assert_matches_type(AnnotationListResponse, annotation, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncScorecard) -> None:
        response = await async_client.records.annotations.with_raw_response.list(
            "777",
        )
    ...
    async def test_streaming_response_list(self, async_client: AsyncScorecard) -> None:
        async with async_client.records.annotations.with_streaming_response.list(
            "777",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_list(self, async_client: AsyncScorecard) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `record_id` but received ''"):
            await async_client.records.annotations.with_raw_response.list(
                "",
            )
