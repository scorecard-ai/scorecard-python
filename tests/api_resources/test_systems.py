...
class TestSystems:
    ...
    def test_raw_response_upsert(self, client: Scorecard) -> None:
        response = client.systems.with_raw_response.upsert(
            project_id="314",
            config={
                "temperature": "bar",
                "maxTokens": "bar",
    ...
    def test_streaming_response_upsert(self, client: Scorecard) -> None:
        with client.systems.with_streaming_response.upsert(
            project_id="314",
            config={
                "temperature": "bar",
                "maxTokens": "bar",
    ...
    def test_path_params_upsert(self, client: Scorecard) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `project_id` but received ''"):
            client.systems.with_raw_response.upsert(
                project_id="",
                config={
                    "temperature": "bar",
                    "maxTokens": "bar",
...
class TestAsyncSystems:
    ...
    async def test_method_upsert(self, async_client: AsyncScorecard) -> None:
        system = await async_client.systems.upsert(
            project_id="314",
            config={
                "temperature": "bar",
                "maxTokens": "bar",
    ...
    async def test_raw_response_upsert(self, async_client: AsyncScorecard) -> None:
        response = await async_client.systems.with_raw_response.upsert(
            project_id="314",
            config={
                "temperature": "bar",
                "maxTokens": "bar",
    ...
    async def test_streaming_response_upsert(self, async_client: AsyncScorecard) -> None:
        async with async_client.systems.with_streaming_response.upsert(
            project_id="314",
            config={
                "temperature": "bar",
                "maxTokens": "bar",
    ...
    async def test_path_params_upsert(self, async_client: AsyncScorecard) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `project_id` but received ''"):
            await async_client.systems.with_raw_response.upsert(
                project_id="",
                config={
                    "temperature": "bar",
                    "maxTokens": "bar",
