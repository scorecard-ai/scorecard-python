...
from scorecard_ai import Scorecard, AsyncScorecard, DefaultAioHttpClient
from scorecard_ai._utils import is_dict
...
logging.getLogger("scorecard_ai").setLevel(logging.DEBUG)
...
def client(request: FixtureRequest) -> Iterator[Scorecard]:
    ...
    with Scorecard(base_url=base_url, api_key=api_key, _strict_response_validation=strict) as client:
        yield client
