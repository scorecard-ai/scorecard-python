...
class TestScorecard:
    client = Scorecard(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=True)
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = Scorecard(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            strict_client.get("/foo", cast_to=Model)

        client = Scorecard(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=False)
    ...
    def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter) -> None:
        ...
        with pytest.raises(APITimeoutError):
            self.client.get(
                "/testsets/testsetId", cast_to=httpx.Response, options={"headers": {RAW_RESPONSE_HEADER: "stream"}}
            )
    ...
    def test_retries_taken(
        ...
        respx_mock.get("/testsets/testsetId").mock(side_effect=retry_handler)

        response = client.testsets.with_raw_response.get("testsetId")
    ...
    def test_omit_retry_count_header(
        ...
        response = client.testsets.with_raw_response.get("testsetId", extra_headers={"x-stainless-retry-count": Omit()})
    ...
    def test_overwrite_retry_count_header(
        ...
        response = client.testsets.with_raw_response.get("testsetId", extra_headers={"x-stainless-retry-count": "42"})

        assert response.http_request.headers.get("x-stainless-retry-count") == "42"


class TestAsyncScorecard:
    client = AsyncScorecard(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=True)
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = AsyncScorecard(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            await strict_client.get("/foo", cast_to=Model)

        client = AsyncScorecard(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=False)
    ...
    async def test_retries_taken(
        ...
        response = await client.testsets.with_raw_response.get("testsetId")
    ...
    async def test_omit_retry_count_header(
        ...
        response = await client.testsets.with_raw_response.get(
            "testsetId", extra_headers={"x-stainless-retry-count": Omit()}
        )
    ...
    async def test_overwrite_retry_count_header(
        ...
        response = await client.testsets.with_raw_response.get(
            "testsetId", extra_headers={"x-stainless-retry-count": "42"}
        )
